...
class PDFHandler(object):
    ...
    file_bytes : io.IOBase, optional (default: None)
        A file-like stream. Required if filepath is not give

    """

    def __init__(self, filepath=None, pages="1", password=None, file_bytes=None):
        if is_url(filepath):
            filepath = get_url_bytes(filepath)
    ...
    def parse(
        self, flavor="lattice", suppress_stdout=False, parallel=False, layout_kwargs={}, **kwargs
    ):
